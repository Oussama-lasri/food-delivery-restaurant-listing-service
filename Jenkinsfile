pipeline {
  ...
  steps {
    sh 'mvn clean org.jacoco:jacoco-maven-plugin:prepare-agent install sonar:sonar -Dsonar.host.url=http://3.8.145.203:9000/ -Dsonar.token=squ_8482b20a85a908d384194dab6f059ccaab1059a4'
  }
}
